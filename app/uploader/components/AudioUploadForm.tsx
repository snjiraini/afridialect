    ...
    <div className="space-y-6">
        ...
        <div className="space-y-4 border-t pt-6">
          ...
          <div>
            <label htmlFor="dialect" className="block text-sm font-medium text-gray-700 mb-1">
              Dialect <span className="text-red-500">*</span>
            </label>
            <select
              id="dialect"
              value={metadata.dialect}
              onChange={(e) => setMetadata({ ...metadata, dialect: e.target.value })}
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              placeholder="Briefly describe the audio content, context, or topic..."
              className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => setMetadata({ ...metadata, speakerCount: parseInt(e.target.value) || 1 })}
              className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
          </div>
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) => setMetadata({ ...metadata, speakerGender: e.target.value as any })}
              className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
            >
          ...
          <div>
            ...
            <select
              id="speakerAgeRange"
              value={metadata.speakerAgeRange}
              onChange={(e) => setMetadata({ ...metadata, speakerAgeRange: e.target.value as any })}
              className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
            >
      ...
      <div className="flex justify-end">
        <button
          ...
          className="px-6 py-3 bg-blue-600 text-white font-medium rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:bg-gray-300 disabled:cursor-not-allowed"
        >
